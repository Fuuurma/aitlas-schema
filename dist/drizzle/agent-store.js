import { pgTable, text, timestamp, boolean, uuid, integer, json, unique, check, } from "drizzle-orm/pg-core";
...
export const curationReviews = pgTable("curation_reviews", {
    ...
    automatedChecks: json("automated_checks").$type(),
    notes: text("notes"),
